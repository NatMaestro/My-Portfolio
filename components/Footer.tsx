  ...
  return (
    <footer className='w-full pt-20 pb-10' id='contact'>
        <div className="flex flex-col items-center">
            ...
            <a href="mailto:nathanielguggisberg@gmail.com">
                <MagicButton
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center mb-20'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Nathaniel Conduah</p>
