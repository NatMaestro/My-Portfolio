  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We'll collaborte to map out your website's or application's goals, target audience,
        and key functionalities We'll dicuss things like site stucture, navigation, and content requirements.
        ">
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" />} 
            description="Once we agree on the plan, I cue in my playlist and dive into coding. 
        ...
        I'll translate everything into code, building your website from the ground up.
        "
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        group-hover/canvas-card:opacity-0 transition 
        duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
        <h2 className="dark:text-white text-3xl opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center ">
          {title}
        </h2>
        <h2 className="dark:text-white text-sm text-center
         opacity-0 group-hover/canvas-card:opacity-100 relative z-10
